...
<body>
    ...
    $consulta = "SELECT * FROM livros WHERE codlivro = '$codlivro'";
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="col-sm-12">
                ...
                <form action="atualizando_livros.php?codlivro=<?php echo $codlivro?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="titulo" value=" <?php echo $linha['titulo'];?>" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="auto" name="autor" value=" <?php echo $linha['autor'];?>" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="editora" name="editora" value=" <?php echo $linha['editora'];?>" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="paginas" name="paginas" value=" <?php echo $linha['paginas'];?>" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                                <label for="paginas" class=" form-control-label">Exemplares</label>
                            </div>
                            <div class="col-12 col-md-9">
                                <input type="text" id="paginas" name="exemplares" value=" <?php echo $linha['exemplares'];?>" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col-12 col-md-9">
                                <select name="genero" id="select" class="form-control">
                                    <option value="<?php echo $linha['genero'];?>"><?php echo $linha['genero'];?></option>
