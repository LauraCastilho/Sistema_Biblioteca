        ...
        <div class="content mt-3">
            <div class="col-sm-12">
                <div class="card-body card-block">
                    <form action="atualizando_aluno.php?ra=<?php echo $ra?>" method="POST" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input id="text-input" name="nascimento" value=" <?php echo $linha['dataNascimento'];?>" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <select name="select" id="select" class="form-control">
                                    <option value="<?php echo $linha['turma'];?>"><?php echo $linha['turma'];?></option>
